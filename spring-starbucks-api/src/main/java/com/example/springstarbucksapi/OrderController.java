...
class OrderController {
    ...
    */
    ...
    @ResponseStatus(HttpStatus.OK)
    Card processOrder(@PathVariable Long regid, @PathVariable String cardNumber) {
        ...
        // Find card
        Card paymentCard = cardRepository.findByCardNumber(cardNumber)
        ...
        Card usedPaymentCard = cardRepository.save(paymentCard);

        currentOrder.setStatus("Paid");
        currentRegister.order = orderRepository.save(currentOrder);
        registerRepository.save(currentRegister);
